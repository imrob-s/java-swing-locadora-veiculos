                ...
                .addMenuEvent(new MenuEvent() {
                    ...
                    public void selected(MenuAction menuAction, int[] ints) {
                        ...
                        if (ints.length == 1) {
                            ...
                            if(index==1){
                                if(subIndex==0){
                                    FormManager.getInstance().showForm("Nova Locação", new CatalogoVeiculos());
                                }else if(subIndex==1){
                                ...
                                if(subIndex==0){
                                    ...
                                    FormManager.getInstance().showForm("Cadastro de Modelo", new CadastroCarroGUI());
                                }else if(subIndex==3){
                                ...
                                if(subIndex==0){
                                    FormManager.getInstance().showForm("Dados da Empresa", new CatalogoVeiculos());
                                }else if(subIndex==1){
